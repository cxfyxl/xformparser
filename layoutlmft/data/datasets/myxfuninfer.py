...
class XFUN(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [XFUNConfig(name=f"myxfun.{lang}", lang=lang) for lang in _LANG]
    ...
    def _split_generators(self, dl_manager):
        ...
        urls_to_download = {
            "train": [f"{_URL}{self.config.lang}.mytrain.json", f"{_URL}{self.config.lang}.train.zip"],
            "val": [f"{_URL}{self.config.lang}.myval.json", f"{_URL}{self.config.lang}.val.zip"],
            ...
            for doc in data["documents"]:
                ...
                for line in document:
                    ...
                    for token_id, offset in zip(tokenized_inputs["input_ids"], tokenized_inputs["offset_mapping"]):
                        ...
                        # last_box = tmp_box
                        bbox.append(normalize_bbox(simplify_bbox(line["box"]), size))
                    bbox = [
