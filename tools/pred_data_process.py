...
if __name__ == '__main__':
    ...
    '''
    json_path = '/home/zhanghang-s21/data/DATA/xfund-and-funsd/XFUND-and-FUNSD/zh.train.json'
    save_path = '/home/zhanghang-s21/data/DATA/xfund-and-funsd/XFUND-and-FUNSD/zh.train.align.json'
